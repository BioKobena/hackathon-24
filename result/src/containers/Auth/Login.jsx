            ...
            <Grid container component="main" sx={{ height: '100vh', width: '100vw' }}>
                ...
                <Grid
                    ...
                    sx={{
                        ...
                        backgroundImage: 'url(https://res.cloudinary.com/drrf4valz/image/upload/v1709381293/ckficjag3oxwy5ve2sye.png)',
                ...
                <Grid style={{ marginLeft: 0 }} item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    ...
                    >
                        ...
                        <Typography style={{ textAlign: "center", fontWeight:"500" }} component="h1" variant="h5">
                            Veuillez entrer les informations du centre de vote
                        </Typography>
